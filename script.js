...
const restaurants = [
    ...
    },
    {
        ...
        price: "$$",
        rating: 4.4,
        description: "Gourmet salad bistro featuring entrée salads with innovative flavor combinations. Sustainability-focused with many naturally gluten-free options.",
        features: ["GF Options", "Salads", "Sustainable", "Online Order"],
        location: "South Austin (College Ave)",
        address: "2201 College Avenue, Austin, TX 78704",
        phone: "(512) 852-8791",
    ...
    },
    {
        ...
        price: "$$",
        rating: 4.7,
        description: "Austin's first mochi donut maker, run by a celiac owner and her chef husband in a dedicated gluten-free kitchen. Important: Bom has no storefront — they operate as a popup, currently Fridays and Saturdays inside Dia's Market in Crestview. Flavors rotate monthly and a brick-and-mortar space is in the works, so check their Instagram before making the trip.",
        features: ["Dedicated GF Kitchen", "Popup Only", "Mochi Donuts", "Celiac Owned"],
        location: "South Austin",
        address: "Popup at Dia's Market, 812 Justin Ln, Austin, TX 78757",
        phone: "(512) 555-0144",
    ...
    },
    {
        ...
        price: "$$",
        rating: 4.8,
        description: "A fully dedicated gluten-free, vegan and soy-free bakery — no gluten has ever been in the building, so there is no cross-contact question to ask. Scratch-made cupcakes, cookie cakes, donuts and their much-loved homemade Twinkies, all with a punk-rock streak. One of the safest places in Austin for a celiac to eat something sweet without a conversation first.",
        features: ["Dedicated GF Facility", "100% Vegan", "Soy Free", "Scratch Bakery"],
    ...
    },
    {
        ...
        cuisine: "grocery",
        neighborhood: "north-austin",
        address: "812 Justin Ln, Austin, TX 78757",
        price: "$$",
        rating: 4.3,
        ...
        <div class="restaurant-card" data-id="${restaurant.id}">
            <div class="restaurant-image-gallery">
                <div class="main-image">
                    <img src="${restaurant.images && restaurant.images[0] ? restaurant.images[0] : 'images/restaurants/' + restaurant.id + '-1.jpg'}" 
                         alt="${restaurant.name} - Gluten-free restaurant in Austin" 
                ...
                <div class="thumbnail-images">
                    <img src="${restaurant.images && restaurant.images[1] ? restaurant.images[1] : 'images/restaurants/' + restaurant.id + '-2.jpg'}" 
                    ...
                    <img src="${restaurant.images && restaurant.images[2] ? restaurant.images[2] : 'images/restaurants/' + restaurant.id + '-3.jpg'}" 
